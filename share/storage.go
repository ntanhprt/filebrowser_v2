...
type StorageBackend interface {
	...
	GetPublic() ([]*Link, error)
	GetPublicByUserID(id uint) ([]*Link, error)
}
...
// GetPublic wraps a StorageBackend.GetPublic
func (s *Storage) GetPublic() ([]*Link, error) {
	links, err := s.back.GetPublic()
...
// GetPublicByUserID wraps a StorageBackend.GetPublicByUserID
func (s *Storage) GetPublicByUserID(id uint) ([]*Link, error) {
	links, err := s.back.GetPublicByUserID(id)
